...
- Good `morning/afternoon`, my name is `Sapphire`, and I am a Node.js FullStack Developer with 5 years of experience.

- I am looking forward to a new job and I perfer to work in foreign company.

-  In my spare time , i deepen my programming skills.  As a backend Developer,i also learn some FrontEnd skills like React or Taro applet and deploy skills like docker/kubernates. and i can learn new technology in a short period of time.
